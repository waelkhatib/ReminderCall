...
public final class RingtonePickerDialog extends DialogFragment {
    ...
    public Dialog onCreateDialog(Bundle savedInstanceState) {
        ...
        AlertDialog.Builder builder = new AlertDialog.Builder(getActivity(),R.style.MyTimePickerDialogStyle)
    ...
    public static class Builder {
         ...
         */
        public RingtonePickerDialog.Builder setTitle(@Nullable String title) {
            mTitle = title;
            return this;
        }
         ...
         * @return {@link RingtonePickerDialog.Builder}
         */
        public RingtonePickerDialog.Builder setPositiveButtonText(@NonNull String positiveButtonText) {
            //noinspection ConstantConditions
         ...
         * @return {@link RingtonePickerDialog.Builder}
         */
        public RingtonePickerDialog.Builder setPositiveButtonText(@StringRes int positiveButtonText) {
         ...
         * @return {@link RingtonePickerDialog.Builder}
         */
        public RingtonePickerDialog.Builder setCancelButtonText(@Nullable String cancelButtonText) {
         ...
         * @return {@link RingtonePickerDialog.Builder}
         */
        public RingtonePickerDialog.Builder setCancelButtonText(@StringRes int cancelButtonText) {
         ...
         * @return {@link RingtonePickerDialog.Builder}
         */
        public RingtonePickerDialog.Builder addRingtoneType(@RingtoneTypes int ringtoneType) {
         ...
         * @return {@link RingtonePickerDialog.Builder}
         */
        public RingtonePickerDialog.Builder setPlaySampleWhileSelection(boolean playSample) {
         ...
         * @return {@link RingtonePickerDialog.Builder}
         */
        public RingtonePickerDialog.Builder setCurrentRingtoneUri(@Nullable Uri currentRingtoneUri) {
         ...
         * @return {@link RingtonePickerDialog.Builder}
         */
        public RingtonePickerDialog.Builder setListener(@NonNull RingtonePickerListener listener) {
            //noinspection ConstantConditions
            if (listener == null)
    ...
    @IntDef({RingtonePickerDialog.Builder.TYPE_RINGTONE,
            RingtonePickerDialog.Builder.TYPE_ALARM,
            RingtonePickerDialog.Builder.TYPE_MUSIC,
